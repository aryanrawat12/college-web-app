...
import type { ContactInfo } from "@/lib/queries";
...
export default function BottomBar({ contact }: { contact: ContactInfo }) {
  const { emails, helpline } = contact;
      ...
      <div className="bg-brand-blue-dark text-white">
        <div className="container-page flex flex-col items-start justify-between gap-6 py-12 sm:flex-row sm:items-center">
          ...
          <div className="flex shrink-0 flex-wrap gap-3">
            ...
            {contact.prospectusUrl && (
              <a
                href={contact.prospectusUrl}
      ...
      <div className="container-page grid grid-cols-1 gap-10 py-14 sm:grid-cols-2 lg:grid-cols-[1.4fr_1fr_1fr_1.3fr]">
          ...
          {contact.mapsQuery && (
            <div className="mt-3 flex-1 overflow-hidden rounded-xl border border-white/15">
              <iframe
                ...
                src={`https://maps.google.com/maps?q=${encodeURIComponent(contact.mapsQuery)}&hl=en&z=15&output=embed`}
            ...
            <p className="mt-2 flex items-center gap-2.5 text-sm">
              ...
              <span>
                ...
                <a
                  ...
                  className="font-semibold text-white hover:text-brand-gold-light"
                >
                  {helpline}
                </a>
              </span>
        ...
        <div>
          ...
          <div className="mt-5 flex gap-2">
            ...
            {contact.youtubeUrl && (
              <SocialLink href={contact.youtubeUrl} label="YouTube">
